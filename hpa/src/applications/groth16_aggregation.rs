// extern crate ark_ec;
// use self::ark_ec::{group::Group, AffineCurve, PairingEngine};

// // extern crate ark_ff;
// // use self::ark_ff::{to_bytes, Field, One};
// extern crate ark_ff;
// use self::ark_ff::{to_bytes, Field, One};
// extern crate ark_groth16;
// use self::ark_groth16::{Proof, VerifyingKey};

// use std::ops::AddAssign;

// extern crate ark_std;
// use self::ark_std::rand::{rngs::StdRng, Rng, SeedableRng};
// extern crate digest;
// use self::digest::Digest;

// extern crate ark_ip_proofs;
// use self::ark_ip_proofs::{
//     tipa::{structured_scalar_message::{structured_scalar_power, TIPAWithSSM, TIPAWithSSMProof},TIPAProof, VerifierSRS, SRS, TIPA,
//     },
//     Error,
// };
