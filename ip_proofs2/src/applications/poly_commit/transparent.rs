...
use crate::{
    ...
    tipa::structured_scalar_message::{
        structured_scalar_power, DORYWithSSM, SSMPlaceholderCommitment,
    },
    Error,
};
...
type PolynomialEvaluationSecondTierIPA<P, D> = DORYWithSSM<
...
type PolynomialEvaluationSecondTierIPAProof<P, D> = DORYProof<
    MultiexponentiationInnerProduct<<P as PairingEngine>::G1Projective>,
    AFGHOCommitmentG1<P>,
...
type PolynomialEvaluationFirstTierIPA<P, D> = DORYWithSSM<
...
type PolynomialEvaluationFirstTierIPAProof<P, D> = DORYProof<
    ScalarInnerProduct<<P as PairingEngine>::Fr>,
    PedersenCommitment<<P as PairingEngine>::G1Projective>,
    SSMPlaceholderCommitment<<P as PairingEngine>::Fr>,
    IdentityCommitment<<P as PairingEngine>::Fr, <P as PairingEngine>::Fr>,
